...
class CustomerFilter(django_filters.FilterSet):
    ...
    phone_pattern = django_filters.CharFilter(method='filter_phone_pattern')  # Custom: starts with +1
...
class ProductFilter(django_filters.FilterSet):
    ...
    # Low stock challenge: stock_lt for <10
...
class OrderFilter(django_filters.FilterSet):
    ...
    # Challenge: Filter by specific product ID (orders containing it)
...
# For sorting: We'll handle in schema resolve (simple asc/desc)